	...
	<body>
		<category name="Ammo Mod 1.1">
			...
			<category name="Description">
				<comment>Ammo Mod by Lollo for BL2 & TPS</comment>
				...
				<comment></comment>
				<comment>------- You will receive an error message about immporting a mod from BL2 or TPS. Ignore this. -------</comment>
