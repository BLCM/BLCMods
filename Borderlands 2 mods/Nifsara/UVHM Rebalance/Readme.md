...
*Both come in an optional UVHM+ compatible version. For example, if you want Hard and UVHM+, you only need to download "(Hard with UVHM+)." Be sure to also use the UVHM+ mod for all of the features.*
