...
1. Hexedit 430083FE32 into 430083FE01 in your Borderlands2.exe (Tutorial soon™)
...
3. Download and run the Level1UVHM.txt mod like any other mod (contains hotfixes so mod merging is needed if you run multiple hotfixed mods)

The included save files are needed because they have UVHM unlocked. 

You can also grab the two weapon SDUs from the bank because you won't get them from the quest.

Pro tip: You can find a bank at Claptrap's Place.