## *Aaron0000's Violator (Pocket Rocket)* - Traduction Française
...
Le Mod *Aaron0000's Violator (Pocket Rocket) Traduction Française* est un simple patch de traduction qui permet d'obtenir en Français tous ajouts de textes (Anglais) du Mod *Aaron0000's Violator (Pocket Rocket)*.

### Utilisation:

Ce Mod comprend la traduction Française des ajouts Anglais de la version *Aaron0000's Violator (Pocket Rocket)*, mais pas le Mod original bien évidemment. 
...
- 100% compatible avec:
  ...
  - la dernière version de [Violator (Pocket Rocket)](https://github.com/BLCM/BLCMods/blob/master/Borderlands%202%20mods/Aaron0000/Pistols/Violator.txt) de [Aaron0000](https://github.com/BLCM/BLCMods/tree/master/Borderlands%202%20mods/Aaron0000)

:warning: N'oubliez pas de placer ce Mod __APRES__ le Mod *Aaron0000's Violator (Pocket Rocket)* :warning:
