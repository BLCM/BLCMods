## *Aaron0000's Moxxi's Endowment (Health-Leech)* - Traduction Française
...
Le Mod *Aaron0000's Moxxi's Endowment (Health-Leech) Traduction Française* est un simple patch de traduction, a ajouter après le Mod original, qui permet d'obtenir en Français tous ajouts de textes (Anglais) du Mod *Aaron0000's Moxxi's Endowment (Health-Leech)*.

### Utilisation:

Ce Mod comprend la traduction Française des ajouts Anglais de la version *Aaron0000's Moxxi's Endowment (Health-Leech)*, mais pas le Mod original bien évidemment.
...
- 100% compatible avec:
  ...
  - la dernière version (18-12-2018) de [Moxxi's Endowment (Health-Leech)](https://github.com/BLCM/BLCMods/blob/master/Borderlands%202%20mods/Aaron0000/Relics/HealthyEndowment.txt) de [Aaron0000](https://github.com/BLCM/BLCMods/tree/master/Borderlands%202%20mods/Aaron0000)

:warning: N'oubliez pas de placer ce Mod __APRES__ le Mod *Aaron0000's Moxxi's Endowment (Health-Leech)* :warning:
