## *Orudeon's Gears Overhaul* - Traduction Française
...
Le Mod *Orudeon's Gears Overhaul Traduction Française* est un simple patch de traduction, a ajouter après le Mod original, qui permet d'obtenir en Français tous ajouts de textes (Anglais) du Mod *Gears Overhaul by Orudeon*.

__Note:__ Ce pack inclus les traductions Française (disponible séparément) suivantes:
- Bandit Brand Tweaks by Orudeon - French Add-On
- Jakobs Brand Tweaks by Orudeon - French Add-On
- Prefix Rework by AngrierPat - French Add-On
- Relic Overhaul by Orudeon - French Add-On
- Shield Behavior Overhaul by Orudeon - French Add-On
- Shield Stat Tweaks by Orudeon - French Add-On
- Tediore Brand Overhaul by Orudeon - French Add-On

### Utilisation:

Ce Mod comprend la traduction Française des ajouts Anglais de la version *Orudeon's Gears Overhaul v1.36*, mais pas le Mod original bien évidemment.
...
- 100% compatible avec:
  ...
  - la dernière version (v1.36) de [Gears Overhaul](https://github.com/BLCM/BLCMods/blob/master/Borderlands%202%20mods/Orudeon/Gear%20Overhaul%201.36.txt) de [Orudeon](https://github.com/BLCM/BLCMods/tree/master/Borderlands%202%20mods/Orudeon)

:warning: N'oubliez pas de placer ce Mod __APRES__ le Mod *Orudeon's Gears Overhaul* :warning:
